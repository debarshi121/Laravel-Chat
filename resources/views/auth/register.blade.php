...
<div class="min-h-screen flex flex-col items-center justify-center bg-gray-300">
  <div class="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
      ...
      <form action="{{ route('register') }}" method="POST">
        ...
        <div class="flex flex-col mb-6">
          ...
          <div class="relative">
            ...
            <input id="email" type="email" name="email" value="{{ old('email') }}" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="E-Mail Address" required/>
          </div>
        </div>
        ...
        <div class="flex flex-col mb-6">
          ...
          <div class="relative">
            ...
            <input id="name" type="text" name="name" value="{{ old('name') }}" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="John Doe" required/>
          </div>
        </div>
    ...
    <div class="flex justify-center items-center mt-6">
      <a href="{{ route('login.show') }}" class="inline-flex items-center font-bold text-blue-500 hover:text-blue-700 text-xs text-center">
        <span>
          <svg class="h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
